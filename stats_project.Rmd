...
```
Roughly 8% of values from price column missing, the rest are complete. 


# Variable of interest
```{r}
summary(mergeDF$price)
...
```{r}
mean(rides$mergeDF[rides$cab_type == "Uber"], na.rm = T)
mean(rides$mergeDF[rides$cab_type == "Lyft"], na.rm = T)

t.test(rides$mergeDF[rides$cab_type == "Lyft"], rides$mergeDF[rides$cab_type == "Uber"])

rides$mergeDF[rides$cab_type == "Uber"]
...
mean(mergeDF$price[mergeDF$TOD == "morning"], na.rm = T)
mean(mergeDF$price[mergeDF$TOD == "night"], na.rm = T)
mean(mergeDF$price[mergeDF$TOD == "evening"], na.rm = T)
