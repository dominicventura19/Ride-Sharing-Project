...
Here is a scatter plot of price vs distance broken down by ride type for both Uber and Lyft. When broken down by ride type, it becomes clear there is some strong positive linear relationship between price and distance. 
<br>
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
```
<br>
As we can see, there really are high correlations between distance and price when broken down by ride type.
<br>
<br>
